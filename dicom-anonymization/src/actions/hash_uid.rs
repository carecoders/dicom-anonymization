...
/// Action that anonymizes DICOM UID (Unique Identifier) values by generating new UIDs from hashes.
///
/// This action replaces UID values with new UIDs generated by hashing the original UID
/// and prepending an optional UID root. The resulting UIDs maintain uniqueness
/// while removing any identifying information from the original UIDs.
